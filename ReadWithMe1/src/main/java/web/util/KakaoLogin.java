...
public class KakaoLogin {
	...
	public static JsonNode getAccessToken(String autorize_code) {
		...
		postParams.add(new BasicNameValuePair("client_id", "340845721c27a182bf54bae03bc43340")); // REST API KEY
		postParams.add(new BasicNameValuePair("redirect_uri", "http://localhost:8888/login/kakao")); // 리다이렉트 URI
	...
	public static UserTb changeData(JsonNode userInfo) {
		UserTb user = new UserTb();

		user.setId(userInfo.path("id").asText());
