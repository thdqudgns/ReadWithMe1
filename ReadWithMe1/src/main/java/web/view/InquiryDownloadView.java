...
public class InquiryDownloadView extends AbstractView {

	private static final Logger logger = LoggerFactory.getLogger(InquiryDownloadView.class);
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		String outputName = URLEncoder.encode(inquiry_file.getOrigin_name(), "UTF-8");
