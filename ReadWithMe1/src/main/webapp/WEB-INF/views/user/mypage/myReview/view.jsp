...
<tbody class="review-board">
  ...
  <tr>
    ...
    <td class="review-tb-right" colspan="2">
		...
		<a href="/user/mypage/myReview/update?review_no=${viewReview.review_no }"><button class="btn-none">수정</button></a> | 
		<a href="/user/mypage/myReview/delete?review_no=${viewReview.review_no }"><button class="btn-none">삭제</button></a>
		</c:if>
    </td>
  </tr>
</tbody>
...
첨부파일: <a href="/user/mypage/myReview/download?file_no=${reviewfile.file_no }">${reviewfile.origin_name }</a>
</div>
...
<div class="center">
	<button type="button" id="btn_brown" class="btn-brown" style="width:70px">목록</button>
</div>
