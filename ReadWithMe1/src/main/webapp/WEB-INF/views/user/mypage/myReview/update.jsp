...
<input type="hidden" name="review_no" value="${view.review_no }">
	...
	<div class="form-group">
		...
		<input type="text" id="writer" value="${user_nick }" readonly="readonly"
			class="form-control" />
	</div>

	<div class="form-group">
		<label for="review_title">제목</label>
		<input type="text" id="review_title" name="review_title" class="form-control" value="${view.review_title }" />
	</div>
