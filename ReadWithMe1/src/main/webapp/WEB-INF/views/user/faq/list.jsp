...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#btnSearch").click(function() {
			...
			$(location).attr("href", "/user/faq/list?type=" + ${paramData.type } + "&search=" + $("#search1").val());
					...
					<ul class="pagination pagination-sm justify-content-center">
						...
						<c:if test="${paging.curPage ne 1 }">
							<li class="page-item"><a class="page-link"
								href="/user/faq/list?curPage=1${searchParam }">처음</a></li>
						</c:if>
						...
						<c:choose>
							<c:when test="${paging.startPage ne 1 }">
								<li class="page-item"><a class="page-link"
									href="/user/faq/list?curPage=${paging.startPage - paging.pageCount }${searchParam }">&laquo;</a></li>
							</c:when>
						...
						<c:if test="${paging.curPage > 1 }">
							<li class="page-item"><a class="page-link"
								href="/user/faq/list?curPage=${paging.curPage - 1 }${searchParam }">&lt;</a></li>
						</c:if>
						...
						<c:forEach begin="${paging.startPage }" end="${paging.endPage }"
							...
							<c:if test="${paging.curPage eq i }">
								<li class="page-item active"><a class="page-link"
									href="/user/faq/list?curPage=${i }${searchParam }">${i }</a></li>
							</c:if>
						...
						<c:choose>
							<c:when test="${paging.endPage ne paging.totalPage }">
								<li class="page-item"><a class="page-link"
									href="/user/faq/list?curPage=${paging.startPage + paging.pageCount }${searchParam }">&raquo;</a></li>
							</c:when>
						...
						<c:if test="${paging.curPage ne paging.totalPage }">
							<li class="page-item"><a class="page-link"
								href="/user/faq/list?curPage=${paging.totalPage }${searchParam }">끝</a></li>
						</c:if>
