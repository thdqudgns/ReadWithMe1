...
<body>
	<div id="errorlayout">
		...
		<div>
			...
			&nbsp;&nbsp; 회원가입하기  &rArr; <a href="<%=request.getContextPath()%>/join">회원가입</a><br>
			&nbsp;&nbsp; 로그인하기  &rArr; <a href="<%=request.getContextPath()%>/login">로그인</a><br>
			</p>
			
		</div>
		<br><br>
		<a href="<%=request.getContextPath()%>/"><img src="https://i.imgur.com/BH7NGuy.png" style="width: 200px"></a>
	</div>
